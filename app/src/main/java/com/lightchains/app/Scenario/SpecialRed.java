 ...
 */
public class SpecialRed extends Lamp {
    static BitmapContainer bc = new BitmapContainer(4);//constructor creates the array;
    static int bonus = 100;
    static int point = 50;
    static double consume = 5;
    static int referenceBonus = Led1.bonus;
    static int referencePoint = Led1.point;
    static double referenceConsume = Led1.consume;
    public SpecialRed(Context context, int x, int y, int width, int power){
        ...
        this.y = y;
        this.power = power;
        Bitmap lampOff1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_off);
        Bitmap lampOff2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_on1);
        Bitmap lampOff3 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_on2);
        Bitmap lampOn = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_on3);
        Bitmap lampBurst1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_on2);
        Bitmap lampBurst2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_on3);
        Bitmap lampBurst3 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_red_burst);
