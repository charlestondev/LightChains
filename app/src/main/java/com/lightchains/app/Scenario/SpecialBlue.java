 ...
 */
public class SpecialBlue extends Lamp {
    static BitmapContainer bc = new BitmapContainer(4);//constructor creates the array;
    static int bonus = 100;
    static int point = 50;
    static double consume = 5;
    static int referenceBonus = Led2.bonus;
    static int referencePoint = Led2.point;
    static double referenceConsume = Led2.consume;
    
    public SpecialBlue(Context context, int x, int y, int width, int power){

        this.width = width;
        this.x = x;
        this.y = y;
        this.power = power;
        Bitmap lampOff1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_off);
        Bitmap lampOff2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_on1);
        Bitmap lampOff3 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_on2);
        Bitmap lampOn = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_on3);
        Bitmap lampBurst1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_on2);
        Bitmap lampBurst2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_on3);
        Bitmap lampBurst3 = BitmapFactory.decodeResource(context.getResources(), R.drawable.special_blue_burst);
